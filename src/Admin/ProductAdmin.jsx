...
const ProductAdmin = () => {
  ...
  return (
    <div className="bg-fourth min-h-screen p-5">
      <h1 className="text-primary text-4xl font-bold mb-6 text-center">
        Product List
      </h1>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-third border border-third rounded-lg shadow-md">
          <thead className="bg-secondary">
            <tr>
              <th className="py-3 px-5 text-left text-white font-semibold">
                Image
              </th>
              <th className="py-3 px-5 text-left text-white font-semibold">
                Name
          ...
          <tbody>
            {product.map((product) => (
              ...
              >
                ...
                <td className="py-3 px-5 text-primary font-medium">
                  {product.productName}
                </td>

                <td className="py-3 px-5 text-primary">{product.categoryName}</td>
