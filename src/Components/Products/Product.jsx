...
const Product = () => {
  ...
  const { addToWishlist } = useCart(); // Access addToWishlist from context
    ...
    <div className="min-h-screen bg-gray-100 text-gray-800">
      <div className="container mx-auto p-6">
        ...
        <div className="mt-10 flex justify-center gap-6">
          <button
            className="px-6 py-3 text-white font-semibold rounded-md transform transition duration-300 bg-primary hover:bg-primary-dark"
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-4">
                    <button
                      ...
                      className="mt-4 ml-32 px-6 py-2 bg-secondary text-white font-semibold rounded-md transform transition duration-300 hover:bg-secondary-dark hover:text-slate-900"
                    >
                      View Details
                    </button>
                  </div>
